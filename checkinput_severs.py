...
def input_checker(promptM, errorM):
    while True:
        try:
            num=int(input(promptM))
            return num
        except ValueError:
            print(errorM)

promptM = "Please enter an integer "
errorM = "Incorrect value submitted, please try again"

inputCheck = input_checker(promptM, errorM) 
print (f"The number you entered was {inputCheck}")
